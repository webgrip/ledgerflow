...
- ⬜ commitlint / pre-commit hook for conventional commit messages
- ⬜ CycloneDX SBOM (supply-chain standard — cyclonedx-php-composer)
- ⬜ OpenAPI 3.1 spec (required for M13 Public API)
- ⬜ semantic versioning releases (GitHub Releases + git tags)
